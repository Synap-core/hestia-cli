  ...
  return (
    <span
      className={[
        ...
        "bg-default-100 border border-divider text-foreground",
        CHIP_SIZES[size],
      ].join(" ")}
    >
      ...
      {onRemove ? (
        <button
          ...
          className="text-default-400 hover:text-foreground transition-colors -mr-0.5"
...
export function MultiEntityCell({
  ...
  return (
    <Popover
      ...
      offset={6}
      classNames={{
        content: "bg-content1 border border-divider rounded-xl p-0 min-w-[280px]",
      }}
    >
      <PopoverTrigger>
