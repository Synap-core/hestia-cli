...
import { recovery, RecoverySystem, BackupMetadata, DiagnosisResult, SuggestedFix, RecoveryOptions } from '../lib/recovery.js';
  ...
  program
    ...
    .action(async () => {
      try {
        ...
        const { config } = await (await import('../lib/config.js')).loadConfig();
