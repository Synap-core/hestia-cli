...
import { getConfigValue, updateConfig, getConfigPaths, getCredentials } from '../../lib/utils/index';
import type { UserConfig } from '../../lib/utils/index';
      ...
      try {
        ...
        const config: Partial<UserConfig> = {
          hearth: {
            ...
            role: 'primary',
            reverseProxy: 'nginx', // Default value
          },
          connectors: {
            controlPlane: {
              enabled: true,
