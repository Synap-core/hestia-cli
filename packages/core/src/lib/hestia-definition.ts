...
export const HESTIA_DEFINITION = {
  ...
  layoutConfig: {
    ...
    sidebarItems: [
      ...
      { kind: "view" as const, viewName: "Hearth Nodes", label: "Nodes", icon: "flame" },
      { kind: "view" as const, viewName: "Package Status", label: "Packages", icon: "package" },
      { kind: "view" as const, viewName: "Deployments", label: "Deployments", icon: "rocket" },
      {
        kind: "view" as const,
